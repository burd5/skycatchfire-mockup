        ...
        <ol className="text-center text-3xl">
            ...
            <li className="mb-8">
                ...
                <p className="text-green-300 text-2xl text-left m-auto mt-5 w-3/4 leading-10">
                    I have heard of Firebase before but never used it myself. So I took the opportunity to make this app to get a better feel for it. I use MongoDB for almost all of my projects so Firebase's NoSQL database felt really comfortable. I set up a couple different collections for the Insights, Portfolio, and Team Members page. I did some basic CRUD requests to practice using the firebase database. I also deployed the website using Firebase's built in service. Wow...this was NOT easy. It took me twice as long to deploy the app as it did to build it. After hours of troubleshooting, including reverting back to an old version of Node, painstackingly comparing npm versions of my package.json and package-lock.json files, adding a credit card for the Blaze plan, and countless searches through StackOverflow and other forms, I got the site deployed. Some of this could've been user error, but based on my investigation, it seems like deploying with Next.js is trickier than some other configurations. That being said, Firebase seems like a useful tool for quickly getting apps into production. There is a heavy focus on analytics and SEO's which makes it a good option when creating websites for businesses. 
                </p>
            </li>
            <li className="mb-4">
